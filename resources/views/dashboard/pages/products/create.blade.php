    ...
    <main class="products-create-page">
        <form class="form" action="{{ route('products.create') }}" method="post" enctype="multipart/form-data">
            ...
            <fieldset class="form__element form__element--long form__element--photo">
                ...
                <img class="form__photo-preview" src="{{ asset('img/products/muffin-grey.svg') }}" alt="Фотография продукта"
                    width="40" height="44">
            ...
            <fieldset class="form__element">
                <label class="form__label" for="en-title">Название на монгольском</label>
            ...
            <fieldset class="form__element form__element--file">
                ...
                <p class="form__file-preview" data-instruction="en">Файл не выбран</p>
                <label class="form__file-label" for="mn-instruction">Загрузить файл...</label>
            ...
            <fieldset class="form__element form__element--wide form__element--desc">
                ...
                <textarea class="form__textarea" name="mn-description" placeholder="Англи хэл дээрх бүтээгдэхүүний тайлбар"></textarea>
            </fieldset>
            ...
            <fieldset class="form__element form__element--wide form__element--long">
                ...
                <textarea class="simditor-textarea" name="mn-composition" placeholder="Англи хэл дээрх бүтээгдэхүүний найрлага"></textarea>
            </fieldset>
            <fieldset class="form__element form__element--wide form__element--long">
            ...
            <fieldset class="form__element form__element--wide form__element--long">
                ...
                <textarea class="simditor-textarea" name="mn-indications" placeholder="Англи хэл дээр хэрэглэх заалт"></textarea>
            </fieldset>
            <fieldset class="form__element form__element--wide form__element--long">
            ...
            <fieldset class="form__element form__element--wide form__element--long">
                ...
                <textarea class="simditor-textarea" name="mn-method" placeholder="Англи хэл дээрх аргыг хэрхэн ашиглах вэ"></textarea>
            </fieldset>
