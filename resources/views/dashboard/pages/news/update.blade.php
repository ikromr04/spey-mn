...
@section('content')
    <header class="header">
        ...
        <ul class="header-navigation">
            ...
            <li class="header-navigation-item">
                <a class="header-navigation-link green-bg white" href="{{ route('dashboard.news.create') }}">Добавить
                    новости</a>
            </li>
        </ul>
    </header>
    <ul class="breadcrumbs book-read-page__breadcrumbs">
        ...
        <li class="breadcrumbs-item">
            <a class="breadcrumbs-link current"
                href="{{ route('dashboard.news.update', $news->id) }}">{{ $news->ru_title }}</a>
        </li>
    </ul>
    <main class="news-update-page">
        <form class="form" action="{{ route('news.update') }}" method="post" enctype="multipart/form-data">
            ...
            <fieldset class="form__element form__element--long form__element--photo">
                ...
                <img class="form__photo-preview {{ $news->img ? 'transparent-bg' : '' }}"
                    src="{{ asset('img/news/' . $news->img) }}" alt="Фотография новости" width="40" height="44">
            ...
            <div class="form__element form__element--wide form__element--long"></div>
            <div class="form__element form__element--wide form__element--long"></div>
            ...
            <fieldset class="form__element form__element--wide">
                ...
                <input class="form__input" type="text" name="en-title" id="en-title" autocomplete="off"
                    placeholder="News headline in English" required value="{{ $news->en_title }}">
            </fieldset>
            <fieldset class="form__element form__element--wide">
                ...
                <input class="form__input" type="text" name="mn-title" id="mn-title" autocomplete="off"
                    placeholder="Монгол хэл дээрх мэдээний гарчиг" required value="{{ $news->mn_title }}">
            </fieldset>
            ...
            <fieldset class="form__element form__element--wide form__element--long">
                <legend class="form__label">Новость на монгольском</legend>
                <textarea class="simditor-textarea" name="mn-text" placeholder="Монгол хэлээр мэдээ">{{ $news->mn_text }}</textarea>
            </fieldset>
