            ...
            <div class="container vitrin-container">
                <div class="vitrin-left">
                    ...
                    <div class="vitrin__link-wrap">
                        <a class="button vitrin__link"
                            href="{{ route('contacts') }}#cooperation">{{ __('Cooperate with us') }}</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                        ...
                        <li class="histories__item" data-row="{{ $key + 1 }}" data-family="history">
                            ...
                            <div class="histories__inner" data-family="history">
                                ...
                                <button class="histories__button" type="button" data-family="history">
                                    {{ __('Learn more') }}
                                    <svg data-family="history" xmlns="http://www.w3.org/2000/svg" width="4"
                                        height="8.182" viewBox="0 0 4 8.182">
                                        <path data-family="history" id="Expand_More"
                                            d="M7.477.108,4.091,3.115.7.107a.45.45,0,0,0-.584,0,.339.339,0,0,0,0,.519L3.8,3.893h0a.45.45,0,0,0,.584,0L8.061.626a.339.339,0,0,0,0-.519A.45.45,0,0,0,7.477.108Z"
                                            transform="translate(0 8.182) rotate(-90)" fill="#8f8f8f" />
                                    </svg>
                                </button>
                            </div>
                        </li>
                ...
                <button class="our-history__view-all-btn" type="button" data-family="history">
                    ...
                    <span class="our-history__view-all-icon" data-family="history">
                        <svg data-family="history" xmlns="http://www.w3.org/2000/svg" width="20.008" height="9.782"
                            viewBox="0 0 20.008 9.782">
                            <path data-family="history" id="Expand_More"
                    ...
                    <span class="company-carousel__icon company-carousel__prev-btn">
                        <svg xmlns="http://www.w3.org/2000/svg" width="8" height="14.525" viewBox="0 0 8 14.525">
                            <g id="download" transform="translate(0 14.525) rotate(-90)">
                                <path id="Expand_More"
                                    d="M13.276.216,7.263,6.229,1.251.215A.733.733,0,0,0,.214,1.253l6.53,6.532h0a.732.732,0,0,0,1.036,0l6.53-6.532A.733.733,0,1,0,13.276.216Z"
                                    fill="#fff" />
                            </g>
                        </svg>
                    </span>
                    ...
                    @foreach ($data->sites as $site)
                        @if ($site->id != 7)
                            <li class="countries-item">
                                <a class="countries-link {{ $data->siteID == $site->id ? 'current' : '' }}"
                                    href="{{ route('about') }}?site={{ $site->id }}#geography-presence">{!! $site->location !!}</a>
                            </li>
                        @endif
                    @endforeach
                </ul>
